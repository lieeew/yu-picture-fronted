...
/** getPictureById GET /api/picture/admin/get */
export async function getPictureByIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPictureByIdUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePicture_>('/api/picture/admin/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** listPictureByPage POST /api/picture/admin/list/page */
export async function listPictureByPageUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePicture_>('/api/picture/admin/list/page', {
    method: 'POST',
    headers: {
...
/** doPictureReview POST /api/picture/admin/review */
export async function doPictureReviewUsingPost(
  body: API.PictureReviewRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/picture/admin/review', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** updatePicture POST /api/picture/admin/update */
export async function updatePictureUsingPost(
  body: API.PictureUpdateRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/picture/admin/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** uploadPictureByBatch POST /api/picture/admin/upload/batch */
export async function uploadPictureByBatchUsingPost(
  body: API.PictureUploadByBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseInt_>('/api/picture/admin/upload/batch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** createPictureOutPaintingTask POST /api/picture/edit/out_painting/create_task */
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.BaseResponseCreateOutPaintingTaskResponse_>(
    '/api/picture/edit/out_painting/create_task',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
/** getPictureOutPaintingTask GET /api/picture/edit/out_painting/get_task */
export async function getPictureOutPaintingTaskUsingGet(
  ...
  return request<API.BaseResponseGetOutPaintingTaskResponse_>(
    '/api/picture/edit/out_painting/get_task',
    {
      method: 'GET',
      params: {
        ...params,
...
/** searchPictureByColor POST /api/picture/view/search/color */
export async function searchPictureByColorUsingPost(
  body: API.SearchPictureByColorRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListPictureVO_>('/api/picture/view/search/color', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** searchPictureByPicture POST /api/picture/view/search/picture */
export async function searchPictureByPictureUsingPost(
  body: API.SearchPictureByPictureRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListImageSearchResult_>('/api/picture/view/search/picture', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
